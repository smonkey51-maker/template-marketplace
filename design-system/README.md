...
- User-facing copy uses second person sparingly: *"Scopri i template"*, *"Personalizza con AI"*

### Key Phrases (IT/EN)
- *"Mercato del digitale artigianale"* / *"Artisan digital marketplace"*
- *"Template premium e prompt AI, curati come piccoli oggetti artigianali."*
- *"Kanso · Shizen · Seijaku"* — simplicity, naturalness, tranquility (footer philosophy)
