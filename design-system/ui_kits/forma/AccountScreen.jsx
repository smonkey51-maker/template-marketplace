  ...
  return (
    <div style={{ padding: "0 0 64px" }}>
      ...
      >
        <div
          style={{
            ...
            height: 56,
            borderRadius: "50%",
            background: "rgba(200,145,90,0.2)",
        ...
        <div>
          ...
          <div style={{ fontFamily: FONTS.body, fontSize: 12, color: COLORS.muted, marginTop: 2 }}>
            marco@example.com · Member since 2024
          </div>
        </div>
        <div style={{ flex: 1 }} />
      ...
      <div style={{ padding: "0 24px", maxWidth: 900, margin: "0 auto" }}>
        {/* Tabs */}
        <div
          style={{ display: "flex", borderBottom: `1px solid ${COLORS.border}`, marginBottom: 24 }}
        >
              ...
              <div key={p.id} style={rowStyle}>
                ...
                <div
                  style={{
                    width: 40,
                    height: 40,
                    background: `${platColors[p.type] || COLORS.accent}22`,
                    border: `1px solid ${platColors[p.type] || COLORS.accent}44`,
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    flexShrink: 0,
                ...
                >
                  <span
                    style={{
                      ...
                      textTransform: "uppercase",
                      letterSpacing: "0.1em",
                      color: platColors[p.type] || COLORS.accent,
                    }}
                  >
                    {(p.type || "html").slice(0, 3).toUpperCase()}
                  </span>
                </div>
                <div style={{ flex: 1 }}>
                  <div
                ...
                <div style={{ fontFamily: FONTS.display, fontSize: 16, color: COLORS.accent }}>
                  {formatPrice(p.price)}
                </div>
                <button
                  style={{
        ...
        {tab === "studio-access" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            <div
              style={{
                border: `1px solid rgba(200,145,90,0.3)`,
                background: "rgba(200,145,90,0.06)",
                padding: "20px 24px",
                position: "relative",
              }}
            >
            ...
            <div style={{ border: `1px solid ${COLORS.border}`, padding: "20px 24px" }}>
              ...
              >
                Studio Usage This Month
              </div>
              {[
                ["Templates Generated", "18", "/ unlimited"],
                ["Templates Customised", "34", "/ unlimited"],
                ["AI Tokens Used", "142k", "/ 500k"],
              ].map(([l, v, limit]) => (
                <div
                  key={l}
                ...
                >
                  <span
                    style={{ fontFamily: FONTS.body, fontSize: 12, color: COLORS.muted, flex: 1 }}
                  >
                    {l}
                  </span>
                  <span
