        ...
        <div style={{ flex: 1, minWidth: 0 }}>
                ...
                {[
                  ...
                  <button
                    ...
                    style={{
                      ...
                      letterSpacing: "0.1em",
                      textTransform: "uppercase",
                      background: label === "Desktop" ? COLORS.inputBg : "none",
          ...
          {tab === "details" && (
            <div style={{ padding: "24px", maxWidth: 700 }}>
              ...
              >
                A fully responsive, production-ready SaaS dashboard template built with clean
                semantic HTML and modern CSS. Includes dark mode, multiple chart placeholders,
                sidebar navigation, and full mobile support.
              </p>
              {/* What's included */}
              <div
                style={{
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 24 }}>
                {[
                  ...
                  "Claude AI customisation via Studio",
          ...
          >
            ...
            <div
              style={{
                ...
                height: 52,
                borderRadius: "50%",
                background: `radial-gradient(circle at 35% 30%, #d4a070, ${COLORS.accent} 60%, #9a6030 100%)`,
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                color: "#0d0a06",
                ...
                boxShadow: "inset 0 1px 1px rgba(255,255,255,0.3), 0 8px 24px rgba(0,0,0,0.6)",
                flexShrink: 0,
              }}
            >
              <div
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            <div style={{ display: "flex", gap: 2 }}>
              {[1, 2, 3, 4, 5].map((i) => (
                ...
                >
                  <path
                    d="M6 1l1.2 2.6 2.8.4-2 2 .5 2.8L6 7.6l-2.5 1.2.5-2.8-2-2 2.8-.4z"
