...
const templates = [
  {
    ...
    description: "Full landing page for an online course: hero, curriculum, instructor bio, testimonials and CTA with pricing.",
    price: 1299,
  },
  {
    id: "webinar-registration",
    name: "Webinar Registration Page",
    description: "Live webinar opt-in page with countdown timer, speaker bio, session agenda and email capture form.",
    price: 999,
  },
  {
    id: "course-curriculum-builder",
    name: "AI Course Curriculum Builder",
    description: "Structured AI prompt to generate a complete online course curriculum with modules, lessons, objectives and exercises.",
    price: 999,
  },
  {
    id: "student-success-story",
    name: "Student Success Story Template",
    description: "AI prompt to write compelling student case studies and testimonials that convert visitors into buyers.",
    price: 799,
  },
  {
    id: "course-email-welcome",
    name: "Course Welcome Email Sequence",
    description: "5-part onboarding email sequence for new students: from purchase confirmation to first quick win.",
    price: 1199,
  },
];
