...
export const books: Book[] = [
  {
    ...
    it: {
      ...
      description:
        "Scritto da un ex agente dell'FBI specializzato per anni in comunicazione non verbale, questo manuale resta il punto di riferimento più citato per chi vuole imparare a decodificare segnali corporei e microespressioni con un metodo, non a intuito. La forza del libro non è promettere scorciatoie magiche — è l'opposto: insegna a costruire pazientemente la linea di base di una persona, a distinguere il comfort dal disagio, e a resistere alla tentazione (molto diffusa, anche in questo sito quando si parla di Patrick Jane) di credere che un singolo gesto significhi sempre la stessa cosa. Per chi è arrivato fin qui leggendo gli articoli di Osservatorio sul linguaggio del corpo, è probabilmente la lettura più naturale con cui continuare: meno narrativa, più esercizio pratico quotidiano.",
    },
    en: {
      title: "What Every BODY Is Saying",
      description:
        "Written by a former FBI agent who spent years specialising in nonverbal communication, this book remains the most-cited reference for anyone who wants to decode body signals and microexpressions with a method, not a hunch. Its real strength isn't promising shortcuts — it's the opposite: it patiently teaches how to build a person's baseline, tell comfort from discomfort apart, and resist the very common temptation (one this site pushes back on when discussing Patrick Jane) to believe a single gesture always means the same thing. For anyone who got here through Osservatorio's body-language articles, it's probably the most natural next read: less narrative, more everyday practical exercise.",
    },
  },
  {
