...
export const t = {
  it: {
    ...
    guide: {
      ...
      promptDesc: "Prompt strutturati per qualsiasi AI. Compila i campi e ottieni risultati professionali.",
      ...
      promptStep1Title: "Acquista",
      promptStep1Desc: "Ogni prompt è ottimizzato per un caso d'uso specifico: copywriting, SEO, email, AI assistant.",
      promptStep2Title: "Incollalo nella tua AI",
      promptStep2Desc: "Funziona con Claude, ChatGPT, Gemini o qualsiasi altra AI.",
      promptStep3Title: "Compila e usa",
      promptStep3Desc: "Sostituisci i campi {{placeholder}} con le tue informazioni. Risultato su misura.",
  ...
  en: {
    ...
    guide: {
      ...
      promptTitle: "Prompt Template",
      promptDesc: "Structured prompts for any AI. Fill in the fields, get professional results.",
      ...
      promptStep1Title: "Purchase",
      promptStep1Desc: "Each prompt is optimized for a specific use case: copywriting, SEO, email, AI assistants.",
      promptStep2Title: "Paste into your AI",
      promptStep2Desc: "Works with Claude, ChatGPT, Gemini or any other AI.",
      promptStep3Title: "Fill in and use",
      promptStep3Desc: "Replace {{placeholder}} fields with your information. Professional result, tailored to you.",
