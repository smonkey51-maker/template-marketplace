...
export const bundles: Bundle[] = [
  {
    ...
    price: 2699,
    regularPrice: 3900,
    stripePriceId: "price_TODO_bundle_ai_creator",
    emoji: "🤖",
    accentColor: "violet",
  ...
  },
  {
    ...
    price: 2799,
    regularPrice: 4100,
    stripePriceId: "price_TODO_bundle_wellness_mindset",
    emoji: "💪",
    accentColor: "emerald",
  ...
  },
  {
    ...
    price: 2999,
    regularPrice: 4600,
    stripePriceId: "price_TODO_bundle_money_career",
    emoji: "💰",
    accentColor: "amber",
  ...
  },
  {
    ...
    price: 1999,
    regularPrice: 3000,
    stripePriceId: "price_TODO_bundle_life_admin",
    emoji: "🏠",
    accentColor: "blue",
