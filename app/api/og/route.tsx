  ...
  if (template) {
    ...
    return new ImageResponse(
      (
        ...
        >
          {/* Glows */}
          <div style={{ position: "absolute", top: "-120px", left: "50%", transform: "translateX(-50%)", width: "900px", height: "500px", background: "radial-gradient(ellipse, rgba(10,132,255,0.18) 0%, transparent 65%)", borderRadius: "50%" }} />
          <div style={{ position: "absolute", top: "100px", right: "-100px", width: "400px", height: "400px", background: "radial-gradient(ellipse, rgba(94,92,230,0.12) 0%, transparent 70%)", borderRadius: "50%" }} />

          {/* Brand */}
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "48px" }}>
            <div style={{ fontSize: "18px", fontWeight: 700, color: "#0A84FF", letterSpacing: "0.08em", textTransform: "uppercase" }}>
              TemplateLab
            </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "16px", marginTop: "auto" }}>
            <div style={{ background: "rgba(10,132,255,0.15)", border: "1px solid rgba(10,132,255,0.3)", borderRadius: "100px", padding: "10px 22px", fontSize: "18px", color: "#0A84FF", fontWeight: 700 }}>
              {priceLabel}
            </div>
