  ...
  return (
    <div className="min-h-screen bg-page relative overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-4 sm:px-6 py-12">
        ...
        <h1 style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', serif", fontSize: "clamp(36px, 5vw, 52px)", fontWeight: 400, letterSpacing: "0.01em", lineHeight: 1.1 }} className="text-theme mb-3">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-[14px] text-muted leading-relaxed">
          <section>
            <h2 className="text-[15px] font-semibold text-theme mb-2" style={{ fontFamily: "var(--font-montserrat), sans-serif", letterSpacing: "0.02em" }}>Dati raccolti</h2>
          ...
          <section>
            <h2 className="text-[15px] font-semibold text-theme mb-2" style={{ fontFamily: "var(--font-montserrat), sans-serif", letterSpacing: "0.02em" }}>Utilizzo dei dati</h2>
          ...
          <section>
            <h2 className="text-[15px] font-semibold text-theme mb-2" style={{ fontFamily: "var(--font-montserrat), sans-serif", letterSpacing: "0.02em" }}>Cookie e tracciamento</h2>
          ...
          <section>
            <h2 className="text-[15px] font-semibold text-theme mb-2" style={{ fontFamily: "var(--font-montserrat), sans-serif", letterSpacing: "0.02em" }}>I tuoi diritti</h2>
          ...
          <section>
            <h2 className="text-[15px] font-semibold text-theme mb-2" style={{ fontFamily: "var(--font-montserrat), sans-serif", letterSpacing: "0.02em" }}>Servizi terzi</h2>
