...
export default function Error({
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center gap-6 px-4 text-center">
      <p className="text-[40px]" aria-hidden>⚠️</p>
      ...
      <div className="flex gap-3">
        ...
        <a href="/" className="px-4 py-2 text-[13px] font-semibold border border-theme text-muted hover:text-theme transition-colors">
          ← Home
        </a>
      </div>
    </div>
