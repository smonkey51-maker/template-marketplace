...
const TEMPLATES = [
  {
    ...
    desc: {
      it: "Clienti, follow-up e pipeline senza complessità.",
      en: "Clients, follow-ups and pipeline without complexity.",
    },
    tag: "CRM",
  },
  {
    ...
    desc: {
      it: "Hero, sezioni e CTA pronte per conversione.",
      en: "Hero, sections and CTAs ready to convert.",
    },
    tag: "SITE",
  },
  {
    id: 3,
    type: "Mobile",
    title: { it: "App launch kit", en: "App launch kit" },
    desc: {
      it: "Schermate mobile per validare subito un prodotto.",
      en: "Mobile screens to validate a product quickly.",
    },
    tag: "APP",
  },
  {
    id: 4,
    type: "Pitch",
    title: { it: "Investor deck", en: "Investor deck" },
    desc: {
      it: "Narrativa, mercato, prodotto e ask in 12 slide.",
      en: "Narrative, market, product and ask in 12 slides.",
    },
    tag: "DECK",
  },
  {
    id: 5,
    type: "Notion",
    title: { it: "Content system", en: "Content system" },
    desc: {
      it: "Calendario, asset, status e pubblicazione.",
      en: "Calendar, assets, status and publishing.",
    },
    tag: "OPS",
  },
  {
    id: 6,
    type: "Web",
    title: { it: "SaaS dashboard", en: "SaaS dashboard" },
    desc: {
      it: "UI scura, KPI, card e flussi prodotto.",
      en: "Dark UI, KPIs, cards and product flows.",
    },
    tag: "UI",
  },
];
    ...
    <div className="fp-app-shell">
      ...
      <main className="fp-main">
        <div className="fp-top">
          ...
          <div
            className="fp-card"
            style={{ minHeight: "auto", padding: "20px 28px", textAlign: "center" }}
          >
              ...
              <div className="fp-product-body">
                ...
                <div className="fp-actions" style={{ justifyContent: "flex-start", marginTop: 18 }}>
                  ...
                  <button onClick={() => toggle(x.id)} className="fp-btn">
                    <Heart size={15} fill={saved.includes(x.id) ? "#d4af37" : "none"} />{" "}
                    {t("saved")}
                  </button>
                </div>
