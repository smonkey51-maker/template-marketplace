...
function SuccessContent() {
  ...
  return (
    <div className="relative z-10 bg-surface border border-theme r-glass p-8 max-w-md w-full mx-auto text-center shadow-[0_8px_40px_rgba(0,0,0,0.12)]">
      ...
      <h1 className="display-serif text-[30px] mb-3 tracking-tight text-theme">
        {t[lang].success.title}
      </h1>
        ...
        <>
          <p className="text-[15px] text-muted mb-2">
            ...
            <span className="text-theme font-semibold">
              {t[lang].success.studioAccessPurchased}
            </span>
          </p>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 bg-page">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden" aria-hidden>
        <div
          className="absolute top-[-10%] left-1/2 -translate-x-1/2 w-[600px] h-[400px] rounded-full opacity-50"
