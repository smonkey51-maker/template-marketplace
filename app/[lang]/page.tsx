...
// "%s — Atelier Nove" template, because the brand belongs at the front on the home
// page — hence `title.absolute`, which opts this one page out of the template
// instead of letting it append a second "— Atelier Nove".
const META = {
  it: {
    title: "Atelier Nove — Arte in tasca.",
    description:
  ...
  en: {
    title: "Atelier Nove — Art in your pocket.",
    description:
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      type: "website",
      images: [{ url: ogImage, width: 1200, height: 630, alt: "Atelier Nove" }],
    },
    twitter: {
