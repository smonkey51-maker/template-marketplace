...
const META = {
  it: {
    title: "Chi siamo — ACUME",
    description:
      'ACUME è un progetto di fan indipendente su "Il Mentalist" e la psicologia dell\'osservazione.',
  },
  en: {
    title: "About — ACUME",
    description:
      'ACUME is an independent fan project about "The Mentalist" and the psychology of observation.',
  },
} as const;
