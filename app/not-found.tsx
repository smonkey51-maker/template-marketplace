    ...
    <div className="min-h-screen bg-page flex items-center justify-center px-6 py-16">
      ...
      <div className="relative z-10 text-center max-w-lg w-full">
        ...
        <p
          ...
          style={{ fontFamily: "var(--font-cormorant), 'Cormorant Garamond', Georgia, serif", fontStyle: "italic", fontWeight: 300, color: "var(--accent)", letterSpacing: "-0.02em" }}
        >
          404
        </p>
        ...
        <form onSubmit={handleSearch} className="flex gap-2 max-w-sm mx-auto mb-8">
          <div className="relative flex-1">
            <svg className="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none" width="14" height="14" viewBox="0 0 20 20" fill="none" style={{ color: "var(--muted)" }}>
        ...
        <div className="mb-8">
          <p className="text-[10px] font-normal uppercase tracking-[0.18em] mb-4" style={{ fontFamily: "monospace", color: "var(--accent)" }}>
              ...
              return (
                ...
                >
                  <div className="flex-1 min-w-0">
                    <p className="text-[13px] font-semibold text-theme truncate group-hover:text-accent transition-colors">{name}</p>
                    <p className="text-[11px] text-muted">{formatPrice(tmpl.price)}</p>
                  </div>
                  <svg width="12" height="12" viewBox="0 0 12 12" fill="none" className="text-muted group-hover:text-accent transition-colors flex-shrink-0" aria-hidden>
