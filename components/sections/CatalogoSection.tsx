...
function PreviewChatGPTFreelancer() {
  return (
    ...
    >
      <div
        style={{ width: "70%", height: 3, background: "rgba(212,175,55,0.8)", borderRadius: 1 }}
      />
      <div
        style={{ width: "85%", height: 5, background: "rgba(255,255,255,0.8)", borderRadius: 1 }}
      />
      <div
        style={{ width: "65%", height: 3, background: "rgba(255,255,255,0.3)", borderRadius: 1 }}
      />
          ...
          <div key={i} style={{ display: "flex", alignItems: "center", gap: 5 }}>
            ...
            <div
              style={{
                flex: 1,
                height: 3,
                background: `rgba(0,0,0,${done ? 0.15 : 0.25})`,
                borderRadius: 1,
              }}
            />
          </div>
...
function PreviewRateCalculator() {
  const rows = [
    ["Tariffa ora", "#D4AF37"],
    ["Spese mese", "rgba(0,0,0,0.35)"],
    ["Ore/sett.", "rgba(0,0,0,0.35)"],
    ["Risultato", "#4a8a5a"],
  ];
  return (
    <div
...
function PreviewAntiProcrast() {
  return (
    ...
    >
      <div
        style={{ width: "55%", height: 4, background: "#D4AF37", borderRadius: 1, opacity: 0.9 }}
      />
      <div
        style={{ width: "80%", height: 5, background: "rgba(255,255,255,0.8)", borderRadius: 1 }}
      />
      <div
        style={{ width: "65%", height: 3, background: "rgba(255,255,255,0.3)", borderRadius: 1 }}
      />
        ...
        {[100, 65, 40].map((w, i) => (
          <div
            ...
            style={{
              flex: 1,
              height: 4,
              background: `rgba(212,175,55,${0.7 - i * 0.2})`,
              borderRadius: 1,
            }}
          />
        ))}
...
function PreviewFinanceTracker() {
  ...
  return (
    ...
    >
      ...
      <div
        style={{ flex: 1, display: "flex", alignItems: "flex-end", gap: 2, padding: "4px 2px 0" }}
      >
        {bars.map((h, i) => (
          <div
            key={i}
            style={{
              flex: 1,
              height: `${h}%`,
              background: `rgba(74,138,90,${0.35 + h / 200})`,
...
function PreviewMidjourney() {
  return (
    ...
    >
      <div
        style={{ width: "50%", height: 3, background: "rgba(180,120,255,0.7)", borderRadius: 1 }}
      />
      ...
      <div
        style={{ width: "75%", height: 3, background: "rgba(255,255,255,0.25)", borderRadius: 1 }}
      />
    </div>
  );
}
...
const PREVIEW_CARDS: PreviewCard[] = [
  {
    ...
    editorsPick: true,
    accentColor: "#D4AF37",
    Preview: PreviewChatGPTFreelancer,
  },
  {
    ...
    cat: "Guide",
    accentColor: "#888",
    Preview: PreviewLaunchChecklist,
  },
  {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-8 sm:px-12 max-w-4xl w-full pt-20 pb-14">
        <p
          className="anim-up text-xs font-semibold tracking-widest uppercase mb-3"
          style={
            {
              color: "var(--accent)",
        ...
        <p
          className="anim-up text-white/75 text-sm sm:text-base leading-relaxed mb-3"
        ...
        <Link
          href="/catalogo"
          className="anim-up inline-block mb-8 text-sm font-semibold tracking-wider"
          style={
            {
              color: "var(--accent)",
        ...
        {/* Template card grid */}
        <div
          className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-3.5 w-full"
          ...
          {PREVIEW_CARDS.map((card, i) => (
            ...
            >
              ...
              >
                {card.editorsPick && (
                  <div
                    className="absolute -top-[10px] left-3 flex items-center gap-1 px-2.5 py-1"
                    style={{
                ...
                <p
                  className="text-[9px] uppercase tracking-widest mt-1 px-0.5 pb-0.5"
                  style={{
                    color: card.editorsPick ? "rgba(212,175,55,0.7)" : "rgba(255,255,255,0.38)",
                  }}
                >
                  {card.cat}
                </p>
      ...
      {/* CATALOGO oversized */}
      <div
        className="anim-in absolute bottom-0 left-0 right-0 pointer-events-none select-none overflow-hidden"
        style={{ zIndex: 3, "--delay": "0.5s" } as React.CSSProperties}
        aria-hidden
      >
        <span
          style={{
