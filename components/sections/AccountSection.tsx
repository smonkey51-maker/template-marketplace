  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={
          { zIndex: 1, background: "rgba(12,8,3,0.72)", "--delay": "0.05s" } as React.CSSProperties
        }
      />
      {/* Magic Aura */}
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-8 sm:px-12 max-w-2xl w-full pt-20 pb-14">
        <p
          ...
          style={
            { color: SUN.yellow, letterSpacing: "0.16em", "--delay": "0.2s" } as React.CSSProperties
          }
        >
          Account
        </p>
        ...
        <div
          className="forma-glass-card anim-up flex items-baseline gap-3 mb-8 px-6 py-4"
        ...
        <Link
          href="/account"
          className="anim-up inline-block text-sm font-semibold tracking-wider hover:opacity-100 transition-opacity"
          style={
            {
              color: SUN.yellow,
              borderBottom: `1px solid ${SUN.yellow}`,
              paddingBottom: "3px",
              textDecoration: "none",
      ...
      >
        <span
          style={{
            ...
            lineHeight: 0.85,
            color: "transparent",
            WebkitTextStroke: "1px rgba(245,197,25,0.12)",
