...
const STEPS = [
  {
    ...
    desc: "Esplora il catalogo e trova il formato adatto al tuo progetto.",
  },
  {
    n: "02",
    title: "Personalizza con AI",
    desc: "Descrivi le modifiche che vuoi: Claude le applica in secondi.",
  },
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={
          { zIndex: 1, background: "rgba(6,12,8,0.74)", "--delay": "0.05s" } as React.CSSProperties
        }
      />
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-8 sm:px-12 max-w-2xl w-full pt-20 pb-14">
        <p
          className="anim-up text-xs font-semibold tracking-widest uppercase mb-4"
          style={
            {
              color: MONET_ACCENT,
        ...
        <p
          className="anim-up text-white/60 text-sm sm:text-base leading-relaxed max-w-[38ch] mb-8"
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
          {STEPS.map((step, i) => (
            ...
            >
              <span className="text-xs font-black tracking-widest" style={{ color: MONET_ACCENT }}>
                {step.n}
              </span>
              <p
                className="text-white text-sm font-semibold mt-3 mb-2"
                style={{ fontFamily: "var(--font-jakarta), sans-serif" }}
              >
                {step.title}
              </p>
              <p
                className="text-white/55 text-xs leading-loose"
                style={{ fontFamily: "var(--font-jakarta), sans-serif" }}
              >
                {step.desc}
              </p>
      ...
      <div
        ...
        style={{ zIndex: 6, "--delay": "0.5s" } as React.CSSProperties}
        aria-hidden
      >
        <span
          style={{
