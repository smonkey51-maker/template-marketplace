...
export function FormaLogoAnimated({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 800 200" xmlns="http://www.w3.org/2000/svg"
      ...
      {/* F */}
      <text x="40" y="140" fill="url(#formaGoldAnim)"
        fontSize="120" fontWeight="800" fontFamily="system-ui, sans-serif">
        F
      </text>
      ...
      <circle cx="210" cy="100" r="50"
        ...
        <animate attributeName="stroke-dashoffset"
          from={O_CIRC} to="0" dur="1s" fill="freeze" />
      </circle>

      {/* R */}
      <text x="300" y="140" fill="url(#formaGoldAnim)"
        fontSize="120" fontWeight="800" fontFamily="system-ui, sans-serif" opacity="0">
        R
        <animate attributeName="opacity" from="0" to="1" dur="0.6s" begin="0.8s" fill="freeze" />
      </text>

      {/* M */}
      <text x="420" y="140" fill="url(#formaGoldAnim)"
        fontSize="120" fontWeight="800" fontFamily="system-ui, sans-serif" opacity="0">
        M
...
export function FormaLogoStatic({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 800 200" xmlns="http://www.w3.org/2000/svg"
      ...
      <text x="40" y="140" fill="url(#formaGoldStatic)"
        fontSize="120" fontWeight="800" fontFamily="system-ui, sans-serif">F</text>
      <circle cx="210" cy="100" r="50"
        stroke="url(#formaGoldStatic)" strokeWidth="20" fill="none" />
      <text x="300" y="140" fill="url(#formaGoldStatic)"
        fontSize="120" fontWeight="800" fontFamily="system-ui, sans-serif">R</text>
      <text x="420" y="140" fill="url(#formaGoldStatic)"
        fontSize="120" fontWeight="800" fontFamily="system-ui, sans-serif">M</text>
