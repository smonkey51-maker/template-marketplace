    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            className="relative flex items-center justify-between px-6 pt-3 pb-2"
            style={{ background: "var(--bezel-notch-bg)" }}
          >
            <span className="text-[11px] font-semibold text-theme opacity-80">9:41</span>
            <div
              className="absolute left-1/2 -translate-x-1/2 top-2.5 w-24 h-6 rounded-full border"
              style={{
                background: "var(--bezel-notch-bg)",
                borderColor: "var(--bezel-notch-border)",
              }}
            />
            <div className="flex items-center gap-1 opacity-80">
              ...
              >
                ...
                <rect x="10.5" y="0" width="3.5" height="10" rx="0.5" opacity="0.35" />
              </svg>
        ...
        <div
          ...
          style={{ background: "var(--bezel-button)" }}
        />
        <div
          className="absolute -left-[3px] top-36 w-[3px] h-14 rounded-l-sm"
          style={{ background: "var(--bezel-button)" }}
        />
        <div
          className="absolute -left-[3px] top-52 w-[3px] h-14 rounded-l-sm"
          style={{ background: "var(--bezel-button)" }}
        />
        <div
    ...
    <div className="min-h-screen bg-page flex flex-col">
        ...
        {template && (
          ...
          >
            <svg width="15" height="15" viewBox="0 0 16 16" fill="none" aria-hidden>
              <path
                d="M8 13.5S1.5 9.5 1.5 5A3.75 3.75 0 018 2.3a3.75 3.75 0 016.5 2.7C14.5 9.5 8 13.5 8 13.5z"
                stroke="currentColor"
                strokeWidth="1.5"
      ...
      <div className="flex-1" style={{ paddingBottom: "160px" }}>
        {viewMode === "desktop" ? (
          ...
          <div
            className="flex justify-center items-start pt-20 pb-10 px-4 min-h-screen"
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-muted">
                {lang === "it"
                  ? "Guarda come usare questo template"
                  : "Watch how to use this template"}
              </p>
            </div>
          </div>
          <a
